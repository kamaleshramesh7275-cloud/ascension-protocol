...
* **Guild "Rivalry" System (Asynchronous Competition):** Instead of direct PvP which can be discouraging, guilds can select a "Rival Guild" of similar level. Progress is compared asynchronously over a season based purely on productive metrics (total quests completed, average habit streaks).
